...
import LoanDetailsTable from 'components/Tables/Subcontractor/LoanDetailsTable';

const SubcontractorFinancialOverview = () => {
...
export default SubcontractorFinancialOverview;
