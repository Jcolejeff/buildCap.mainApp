...
export const faqs: Record<any, any[]> = {
  'Payment & pricing': [
    {
    ...
    },
    {
      ...
      body: (
        <p>
          Go to the{' '}
          <span className='font-bold hover:underline'>
            <a href={`/${CONSTANTS.ROUTES['cv-profile']}`}>CV Profile</a>
          </span>{' '}
          section
        </p>
      ),
    ...
    { title: `Can I download my CV generated on the Nollywood Filmmaker website?`, body: `Yes` },
    {
      ...
      body: (
        <div className='gap-4- flex flex-col'>
          ...
          <p>
            Go to the <span className='font-bold hover:underline'></span> section
          </p>
        </div>
      ),
    },
    {
      ...
      body: (
        <p>
          Go to the{' '}
          <span className='font-bold hover:underline'>
            <a href={`/${CONSTANTS.ROUTES['dashboard']}?key=advert`}>advert section</a>
          </span>{' '}
  ...
  'My subscriptions': [
            ...
            {(
              ...
              <TableRow key={idx}>
                ...
                <TableCell className='text-start'>
                  {i?.stu ? <Check className='h-4 w-4' /> : `-`}
                </TableCell>
                <TableCell className='text-start'>
                  {i?.pro ? <Check className='h-4 w-4' /> : `-`}
                </TableCell>
                <TableCell className='text-start'>
                  {i?.master ? <Check className='h-4 w-4' /> : `-`}
                </TableCell>
              </TableRow>
            ))}
          </Table>
    ...
    },
    {
      ...
      body: (
        <p>
          Click <span></span> to view subscription plans
        </p>
      ),
    },
    {
      ...
      body: (
        <p>
          Click <span></span> to renew your subscription
        </p>
      ),
    },
    {
