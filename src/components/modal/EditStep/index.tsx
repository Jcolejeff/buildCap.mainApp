...
const EditStep = ({
  ...
  return (
    <Dialog onOpenChange={(i) => setModalOpen(i)} open={modalOpen}>
      ...
      <DialogContent className=' no-scrollbar mt-4 max-w-full overflow-auto overflow-x-hidden  bg-white px-6 md:h-full md:w-fit md:!max-w-[1000px] lg:px-[2rem]'>
            ...
            <section className='container relative '>
              <div className=' mx-auto    flex max-w-2xl  flex-col gap-1 rounded-[15px] bg-white  md:p-[1.5rem]'>
                ...
                <p className='invisible h-0'>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat dicta eos,
                  corporis temporibus libero qui?
                </p>
                <Form {...form}>
                  <form
                    ...
                    <div className=' flex flex-col items-center gap-4'>
                      ...
                      >
                        <span className='font-[500] leading-[1.5rem] tracking-[0.02875rem] text-white disabled:cursor-not-allowed disabled:opacity-50'>
                          {formIsLoading ? <Spinner /> : 'Edit Step'}
                        </span>
                      </button>
