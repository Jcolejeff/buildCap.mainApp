...
import InformationTab from './UserInfoTab';
import { useState } from 'react';
import ResumeTab from '../testing/testResume';
import ExperiencesTab from './CompanyInfoTab';
import EducationTab from './PasswordTab';
import ProjectsTab from '../testing/testprojects';
...
const UserRegistrationForms = () => {
  ...
  const [data] = useState<string[]>(['Information', 'Experiences', 'Education', 'Projects']);
